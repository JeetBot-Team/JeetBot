module.exports = async (msg, args) => {
    ...
    if(msg.member.hasPermission(["MANAGE_MESSAGES"])) {
        console.log(`${msg.author.username} can prune messages from Discord Server: ${msg.guild}`);
        ...
        console.log(`${msg.author.username} cannot prune messages from Discord Server: ${msg.guild}`);
        return msg.channel.send(`${msg.author.username} does not have the authority to prune messages from the server`);
    }    
};